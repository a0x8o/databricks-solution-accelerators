...
# MAGIC %md The purpose of this notebook is to prepare the dataset we will use to explore collaborative filtering recommenders.  This notebook should be run on a **Databricks 7.1+ cluster**.

# COMMAND ----------

# MAGIC %md # Introduction 
# MAGIC 
# MAGIC Collaborative filters are an important enabler of modern recommendation experiences.  ***Customers like you also bought***-type recommendations provide us an important means of identifying products that are likely to be of interest based on the buying patterns of closely related customers:
# MAGIC 
