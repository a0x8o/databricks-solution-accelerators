...
# MAGIC %md The purpose of this notebook is to build a set of product-pairs representing potential matches between products sold by two retailers.  This notebook has been developed using a Databricks ML 7.6 cluster. 
...
features = (
  spark
    .table('DELTA.`/mnt/matching/silver/abtbuyfeatures`')
...
matches = (
  spark
    .table('DELTA.`/mnt/matching/silver/abtbuy_matched`')
...
(
  labeled_pairs
    ...
    .save('/mnt/matching/silver/labeledpairs')
)
